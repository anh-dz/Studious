...
"")
        ...
        self.lb_task.setGeometry(QRect(0, 0, 200, 60))
        self.lb_task.setLayoutDirection(Qt.LeftToRight)
        self.lb_time = QLabel(Dialog)
        self.lb_time.setObjectName(u"lb_time")
        self.lb_time.setGeometry(QRect(200, 0, 120, 60))
